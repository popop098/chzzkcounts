...
export default function Home() {
    ...
    return (
        <>
            ...
            />
            <main
                className={`flex min-h-screen flex-col items-center justify-center gap-5 p-24 bg-[#141517] space-y-5`}>
                                    ...
                                    searchResult && searchResult.length > 1 ? searchResult.map((channel) => (
                                        <div key={channel.id} className="flex items-center justify-between px-8 py-3">
                                            <div className="flex items-center">
                                                <Image src={channel.channelImageUrl} alt={channel.name} width={40}
                                                       height={40}
